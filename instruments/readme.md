...
The eleven-file prototype set was audited on 2026-08-10. The findings, required corrections, and validation evidence are in [`../_staff/quick-guides/audit-2026-08-10.md`](../_staff/quick-guides/audit-2026-08-10.md); consult it before editing any prototype. It found one publication-stopping print-layout defect common to all eleven files, and confirmed that the FTIR reference's own images and control key need rework before they are reused. Every prototype remains unpublished and unapproved for instrument use.
