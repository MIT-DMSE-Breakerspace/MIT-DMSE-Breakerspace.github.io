...
| Trained user at the SEM | [Standard operating protocol](#sop) |
| New user learning the workflow | [Detailed operating instructions](#details) |
...
| --- | --- | --- |
| Large samples, multiple stubs, or awkward geometry | Phenom XL | Stage accepts samples up to 100 mm x 100 mm x 35 mm. Confirm height before loading. |
| Elemental analysis | Phenom XL | Use EDS for spot checks, maps, reports, and CSV exports. |
| Fast imaging of ordinary dry samples | Phenom XL or Phenom Pure | Choose based on availability and holder compatibility. |
| Frozen, wet, or beam-sensitive samples | Phenom Pure | Use the temperature-controlled cold stage after staff-approved sample prep. |
| One small mounted stub | Phenom Pure | Useful for straightforward imaging when EDS is not needed. |
