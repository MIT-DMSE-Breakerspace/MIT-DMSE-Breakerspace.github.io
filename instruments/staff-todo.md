...
* [ ] Print-test every guide on US Letter at 100% in duplex, grayscale, and color. Check legibility, clipping, page count, long-edge flip, and whether it can be followed while the control software remains fullscreen. The revised FTIR provisional artifact renders as two Letter pages and passes direct HTML validation, but its full canonical identity and provisional badge produce the still-unresolved 31.2 px trained-user-notice/SOP-title overlap. Preserving the original repeat-cycle bullet while adding the confirmed contaminated-background cycle also makes the final shutdown bullet overlap the footer by 46.8 px and extend 0.9 px past the sheet. Its three failed 750x468 sources have been replaced by explicit native-capture placeholders, not approved final media. It still needs a reviewed locked-layout correction, the native captures, label and callout checks, QR decode, color and grayscale proofs, staff content review, and physical duplex proof. See [`../_staff/quick-guides/audit-2026-08-10.md`](../_staff/quick-guides/audit-2026-08-10.md). Optical and XRD keep their older layout until separately authorized for retrofit.
