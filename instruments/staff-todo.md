...
* [ ] Replace the lone large Quick Guide banner above instrument-page overviews with a contextual **At the instrument? Open or print the trained-user Quick Guide** link in Quick Actions. Keep the canonical page and SOP as the apparent web starting point.
