...
* [ ] **Define the normal and failed OMNIC System Status appearances.** The canonical startup requires checking System Status but does not say what a failed connection looks like. Record only observable, staff-verified states so a trainer can assess recognition without inventing an icon, color, message, or recovery cycle.
