...
* [ ] Improve the full LibCal calendar's phone presentation when the embed is in scope. The September 18 Calendar review at 390×844 found clipped event titles in the seven-column week view and the full-calendar fallback below the 600px embed; desktop at 1440×1000 was readable. Review a usable phone view and fallback placement on Calendar. Training no longer uses this embed after PR #48; retain its compact session list.
