...
* [ ] Complete usable Quick Guide/staff-guide pairs for the four first-wave systems, reconciling each pair with the canonical operating page, LibCal description, and access closeout.
    * **SEM checkpoint — 2026-09-11:** Phenom XL and Phenom Pure trainer guides were provisionally reviewed together through the last check in **Navigation, imaging, and data**. Resume at participant-led unloading and shutdown. Imaging-quality practice and the shared-drive/external-storage rule are now represented; confirm the separate XL tray/chamber and Pure holder/chamber final states before promoting either guide.
