...
* [x] Review the compact FTIR trainer guide with the lab manager. On 2026-08-11 its operational gaps were resolved and the guide was marked ready for release while remaining unpublished. The available printed FTIR Quick Guide supports the session; its compact redesign remains a separate project.
