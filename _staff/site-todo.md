...
Last updated: 2026-09-21 for the 24/7/365 access decision and Safety editorial review; other work retains its dated review records below.
...
* [x] Complete the owner-reviewed Safety and Lab Use editorial revision (September 21), approved for publication. A compact emergency notice and early contents list lead to Emergencies and incidents, Working safely, and Lab-use rules. Before You Work, Related Pages, and repeated booking/data reminders are removed; sample restrictions have one home; food and samples precede PPE; injury reporting stays with incidents. Safety requirements and original fragments remain. See the handoff's Safety editorial record for counts, checks, limitations, and release tracking. The supervised-course-participation policy question remains open; the guest rule is unchanged.
