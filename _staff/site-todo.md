...
* [ ] Audit, print-test, laminate, and install the FTIR, optical, and XRD Quick Guides under the [2026-08-03 content contract](../instruments/readme.md#quick-guide-content-contract) before treating them as the rollout model.
* [ ] Demote the current lone large Quick Guide banner on instrument pages to a clearly labeled Quick Actions link for at-instrument use, printing, accessibility, and fallback. Keep the canonical page and SOP as the primary web starting point.
