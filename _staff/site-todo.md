...
* [ ] Run and review the authorized 2026-08-10 provisional staff-guide composition pass using the [controlled procedure and rolling work orders](../_staff-training/provisional-draft-procedure.md). Start with the compact FTIR prototype and prototype-only shared safety/closeout includes, then compose the supported portions of the first-wave guides with explicit review gaps. Compare checklist density, word counts, timing plausibility, and structural exceptions; do not publish a prototype or replace a live guide during this pass.
