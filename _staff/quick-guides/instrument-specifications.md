...
**Remaining release gates:** resolve the Side 1 SOP/footer collision; complete final staff review of the capture states and callout geometry; verify color and grayscale physical output, QR decoding, and label legibility at 100%; and approve a physical duplex proof. The separate current printed Quick Guide is sufficient for trainer-guide release and remains unchanged.
...
**Current provisional render (2026-08-12):** the unpublished include-backed artifact renders as exactly two Letter pages, retains all 24 canonical SOP bullets verbatim and in order, and loads all three native 1920×1080 OMNIC captures. Its targeted HTML-Proofer check passes. Browser checks at 1440, 1024, 768, and 700 px widths show no horizontal overflow and preserve native image dimensions; paginated color and grayscale renders preserve the interface states and callouts. The unreviewed compact display-title trial, **Nicolet iS5 FTIR Spectrometer**, plus the shared 0.04 in advisory spacing leaves a 0.016 px positive trained-user-note/SOP-title gap in automated print measurement without changing SOP content or type size. Side 1 remains overfull: the final shutdown bullet overlaps the footer by 46.828 px and extends 0.906 px past the sheet. Final staff media/callout review, corrected locked pagination, 100% color and grayscale physical proofing, QR scan confirmation, and the physical duplex proof remain unmet.
