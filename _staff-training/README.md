...
* **Per-instrument guides** — FTIR is the reviewed continuous-checklist specimen. Optical was structurally retrofitted to the same run-sheet model on 2026-09-11 and awaits operational review. Two of eleven instruments have live guides; the completed 2026-08-10 provisional pass added five unpublished prototypes without replacing either one.
...
| Optical | Best Image; quick 2D stitch as map image; normal 2D capture; slower high-quality 2D area stitch with **Use as map image** deselected; 3D capture. Mention high-quality 3D stitching; briefly preview LEXT analysis/reporting without teaching it for retention. | Map the five taught DSX functions. Do not map LEXT. Review the triaged multi-state candidates and matched focus pair, then lock and integrate an optical-specific layout. | Public exercise and staff-guide scope were aligned on 2026-08-07; the staff guide received its continuous-checklist retrofit on 2026-09-11. Operational verification, exact mapped controls, save/copy view, final clearance state, layout approval, and practice remain open. |
...
| Second | **Optical microscopy** | Provisional SOP/visual-map composition; triaged interface states and matched focus pair await layout integration and approval | Structurally retrofitted 2026-09-11; needs operational verification and a timed practice run | Run the retrofitted checklist at the instrument, verify the recorded 2D/stitch/3D curriculum and save/final states, then approve the required multi-state map. |
...
* `optical.md` is the DSX-1000 optical-microscope curriculum. It was structurally retrofitted to the continuous run-sheet model on 2026-09-11 and remains blocked on its explicit operational-review gaps and timed practice run.
