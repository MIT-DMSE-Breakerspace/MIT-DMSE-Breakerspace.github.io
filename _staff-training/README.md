...
Last substantive work: 2026-09-14.
...
| Phenom SEM | One combined guide may be delivered on Pure, XL, or both; completion does not require both microscopes. Shared scope is sample screening, NavCam, SEM imaging with BSD/SED, focus and brightness/contrast, accelerating voltage, beam intensity, vacuum mode, **Scan Size 960 × 540**, **Medium Averaging**, acquisition, data handling, and shutdown. Pure uses its room-temperature holder and below-holder-edge rule; introduce but do not demonstrate the temperature-controlled stage. XL Level 1 uses high vacuum and its removable-tray/dial rule; preview EDS when XL is available, or explain it from the operating page when unavailable. | Keep separate Pure and XL Quick Guides and interface sources. The combined trainer guide does not authorize merging the physical loading rules or primary Quick Guides. | Wholesale combined draft created 2026-09-14 and needs line-by-line review and a practice run; Quick Guide review and physical proof remain separate. |
