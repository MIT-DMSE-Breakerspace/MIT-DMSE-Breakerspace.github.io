...
Last substantive work: 2026-09-11.
...
* **Per-instrument guides** — FTIR is the reviewed continuous-checklist specimen. Optical was structurally retrofitted and operationally reviewed on 2026-09-11. The portal publishes those two current guides plus four incomplete prototypes labeled **Draft advisory** for staff review.
...
The lab manager authorized a cross-instrument **provisional staff-guide composition pass**, and the pass was completed on 2026-08-10. It produced trainer-run-sheet prototypes for FTIR, Phenom XL, Phenom Pure, XRD, and Instron while preserving every operational blocker as a specific review gap. FTIR completed review on 2026-08-11 and was released on 2026-08-31; the other four are published in the portal with a **Draft advisory** state and remain visibly incomplete and unapproved for training delivery. The procedure remains in [`provisional-draft-procedure.md`](provisional-draft-procedure.md), results are in [`provisional-draft-work-orders.md`](provisional-draft-work-orders.md), and the original copy-paste assignment is archived in [`CODEX-CLI-PROMPT.md`](CODEX-CLI-PROMPT.md).
...
| Phenom XL | Core high-vacuum SEM imaging uses NavCam; BSD and SED; focus and brightness/contrast; accelerating voltage, beam intensity, vacuum mode, **Live Scan Size 960 × 540**, and **Medium Averaging**; and acquisition at several magnifications. Level 1 includes a brief trainer-led EDS capability demonstration with additional EDS instruction when time permits. The confirmed normal start is tray inside the closed compartment, software closed, Windows at sign-in, and microscope in standby. | Primary map is SEM imaging only; use separate NavCam and SEM states and include the grouped top panel. Do not map EDS operation. | Trainer-guide review resumes at participant-led unloading and shutdown; confirm the final tray/chamber state. Quick Guide source/control approval and physical proof remain separate. |
| Phenom Pure | Room-temperature core imaging uses NavCam and the same general SEM imaging decisions while preserving Pure-specific holder selection and below-holder-edge clearance. The temperature-controlled stage is introduced but not demonstrated; it requires additional training and more time. | Separate Pure NavCam and SEM-view sources; include the grouped top panel and never reuse XL height rules. | Trainer-guide review resumes at participant-led unloading and shutdown; confirm the final holder/chamber state. Pure Quick Guide interface verification and physical proof remain separate. |
...
| --- | --- | --- | --- | --- |
| First | **SEM/EDS** | Provisional compositions published for staff review; XL is near completion and Pure remains less mature | Phenom XL and Phenom Pure draft advisories reviewed together through the final **Navigation, imaging, and data** check | Resume with participant-led unloading and shutdown. Confirm each instrument's final hardware state; Quick Guide controls, proof, and installation remain separate work. |
...
The provisional **staff-guide** composition pass was completed on 2026-08-10. FTIR completed review and was released on 2026-08-31; the other four artifacts are published as incomplete **Draft advisory** review aids. Compare Phenom XL and Phenom Pure together to protect their physical loading differences, review XRD next for its split touchscreen/workstation/log-book path, and review Instron separately as the deliberate multi-surface structural exception. This sequence organizes document review; it does not change the co-equal first-wave rollout priority.

**SEM trainer-guide review checkpoint — 2026-09-11:** Phenom XL and Phenom Pure were reviewed together from pre-session readiness through the last check in **Navigation, imaging, and data**. The review settled pre-session connection, Quick Guide use, known-good demonstration samples, sample-prep-table orientation, instrument-specific holder/tray and height sequencing, training scope, durable-reference orientation, SEM terminology, NavCam-to-SEM navigation, focus and imaging-setting practice, the live-navigation defaults of **960 × 540** and **Medium Averaging**, and `Breakerspace Files` or participant-controlled external storage with no reliance on the local hard drive. Resume both guides at **Participant-led unloading and shutdown**; do not redo the completed sections unless later shutdown decisions require a narrow consistency correction.
...
* `ftir.md` is the reviewed FTIR guide released to the Trainer Portal on 2026-08-31. The Phenom XL, Phenom Pure, XRD, and Instron prototype files are linked from the portal as incomplete **Draft advisory** review artifacts; publication does not approve them for training delivery.
...
The same authorization governed the completed provisional **staff-guide** pass under [`provisional-draft-procedure.md`](provisional-draft-procedure.md). FTIR completed lab-manager review on 2026-08-11 and was released on 2026-08-31. The other four prototypes remain trainer-run-sheet and evidence inventories with unresolved choices; they stay separate from live guide filenames and use prototype-only shared includes until an explicit release step.
