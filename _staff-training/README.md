...
Last substantive work: 2026-08-31.
...
| --- | --- | --- | --- | --- |
| First | **SEM/EDS** | Missing | Phenom XL and Phenom Pure prototypes published as draft advisories; XL review in progress | Capture separate Phenom interfaces and height pairs, then define the result-quality, save/export, and final-state decisions. The XL EDS curriculum boundary was approved 2026-08-20. |
