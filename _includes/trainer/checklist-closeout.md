...
* [ ] **After attendees leave:** add every attendee to [`{{ include.moira }}`](https://groups.mit.edu/webmoira/list/{{ include.moira }}). Do this even if the group grants no workstation login — the mailing-list role depends on it. Do **not** record attendee Kerberos usernames in this repository.
