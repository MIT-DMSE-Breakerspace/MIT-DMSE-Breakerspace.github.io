...
* [ ] **After attendees leave:** add everyone to [`{{ include.moira }}`](https://groups.mit.edu/webmoira/list/{{ include.moira }}), including comms-only groups. Record no participant names, usernames, or private identifiers here.
